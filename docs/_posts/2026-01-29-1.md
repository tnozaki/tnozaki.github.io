...
ということで嫌なら最新の binuils 使えで終わってしまうんだが、やっぱり Meson の --start-group/--end-group を吐く位置が間違ってるとしか思えんし、古い binutils 使う場合には正しい位置で出力してほしいよなって。
...
- lib\*\p.a … gperf によるプロファイリングオブジェクトのアーカイブファイル
